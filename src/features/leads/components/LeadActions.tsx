...
/**
 * Menu d'actions — design raffiné.
 * Ombre portée douce, coins arrondis, icônes subtiles,
 * séparation visuelle entre actions normales et destructive.
 */
  ...
  return (
    <div ref={containerRef} className="relative inline-block">
      <button
        ...
        aria-label={`Actions pour ${leadName}`}
